...
contract UniswapV2Migrator is IUniswapV2Migrator {
    ...
    function migrate(
        ...
        (uint256 amountTRXV1, uint256 amountTokenV1) = exchangeV1.removeLiquidity(liquidityV1, 1, 1, uint256(-1));
        TransferHelper.safeApprove(token, address(router), amountTokenV1);
        (uint256 amountTokenV2, uint256 amountTRXV2, ) = router.addLiquidityTRX{value: amountTRXV1}(
            token,
            amountTokenV1,
            amountTokenMin,
            amountTRXMin,
